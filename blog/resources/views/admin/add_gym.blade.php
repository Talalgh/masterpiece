  ...
  <div class="navbar-menu" id="navbar-menu">
    <div class="navbar-end">
      ...
      <div class="navbar-item dropdown has-divider has-user-avatar">
        <a class="navbar-link">
            <div  style="color: rgb(243,97,0)"class="user-avatar">
      ...
      <a style="color: rgb(243,97,0)" title="Log out" class="navbar-item desktop-icon-only" href="{{route('logout')}}">
        <span style="color: rgb(243,97,0)" class="icon"><i class="mdi mdi-logout"></i></span>
        <span style="color: rgb(243,97,0)">Log out</span>
      </a>
    </div>
  ...
  <div class="menu is-menu-main">
    ...
    <section class="is-title-bar">
        <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
            <ul>
                <li>Admin</li>
                <li style="color:rgb(243,97,0) ">GYM</li>
            </ul>
    ...
    <section class="section main-section">
        <div class="card mb-6">
            ...
            <div class="card-content">
                <form action="{{ route('table-gym.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="field">
                        ...
                        <div class="field-body">
                            ...
                            <div class="field">
                                <div class="control icons-left icons-right">
                                    <input style="width: 40%" class="input" type="text" placeholder="address" name="address">
                                    <span style="color: rgb(243,97,0)" class="icon left"><i class="mdi mdi-map-marker"></i></span>
                                    <!-- Example: Added an address icon using "mdi-map-marker" class -->
                                </div>
                            </div>
                            <hr>
                            <div class="field">
                                <div class="control icons-left icons-right">
                                    <input style="width: 40%" class="input" type="text" placeholder="price" name="price">
                                    <span style="color: rgb(243,97,0)" class="icon left"><i class="mdi mdi-currency-usd"></i></span>
                                    <!-- Example: Added a price icon using "mdi-currency-usd" class -->
                                </div>
                            </div>
                            <hr>
                                    <div class="field">

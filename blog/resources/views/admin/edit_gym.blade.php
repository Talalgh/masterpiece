    ...
    <section class="section main-section">
        <div class="card mb-6">
            ...
            <div class="card-content">
                <form action="{{ route('gyms.update', $gyms->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="field">
                        ...
                        <div class="field-body">
                            <div class="field">
                                <div class="control icons-left">
                                    <input class="input" type="text" placeholder="Name" style="width: 40%" name="name" value="{{ $gyms->name }}">
                                    <span style="color: rgb(243,97,0)" class="icon left"><i class="mdi mdi-account"></i></span>
                                </div>
                            </div>
                            <div class="field">
                                <div class="control icons-left icons-right">
                                    <input style="width: 40%" class="input" type="text" placeholder="Address" name="address" value="{{ $gyms->address }}">
                                    <span style="color: rgb(243,97,0)" class="icon left"><i class="mdi mdi-map-marker"></i></span>
                                </div>
                            </div>
                            <div class="field">
                                <div class="control icons-left icons-right">
                                    <input style="width: 40%" class="input" type="text" placeholder="New Price" name="price" value="{{ $gyms->price }}">
                    ...
                    <div class="field">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input" type="file" placeholder="e.g. Partnership opportunity" style="width: 40%" name="img" value="{{ $gyms->img }}">
                            </div>
                        </div>
                        <br>
                        <br>
                        <div class="field grouped">
                            <div class="control">
                                <button type="submit" class="button" style="background-color: rgb(243,97,0); margin-left: 30px; border: 1px solid white; color: white; font-weight: bold">Submit</button>
                            </div>
                        </div>
                        <br>
                    </form>

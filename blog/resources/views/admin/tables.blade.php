    ...
    <div style="background-color: rgb(31,41,55)" class="notification ">
      <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0">
        <div>
            ...
            <b  style="color: rgb(243,97,0)">Clients</b>
        </div>
      </div>
    </div>
    <hr>
    <br>
    <form action="{{ '/table-admin' }}" method="GET">
          ...
          <tr>
            ...
            <td class="actions-cell">
              <div class="buttons right nowrap">
                ...
                <a style="background-color: white;border: 1px solid rgb(243,97,0)" href="{{ route('table-admin.edit', ['table_admin' => $user->id]) }}" class="button small blue --jb-modal" type="button">
                  ...
                  <form id="deleteForm-{{$user->id}}" action="{{ route('admin.tables.destroy', ['id' => $user->id]) }}" method="POST" style="display: none;">
                    @csrf
                    @method('DELETE')
                  </form>

    ...
    <div id="app">
        ...
        <aside class="aside is-placed-left is-expanded">
            <div class="aside-tools">
                <div>
                    <p style="color: rgb(243,97,0);margin-left: 0px;font-size: 20px;font-weight: bold">G Y M -<span
                            style="color: white;font-weight: normal;font-size: 17px;font-weight: 700"> Dashboard</span>
                    </p>
                </div>
            </div>
        ...
        <section class="section main-section">
            <div class="card mb-6">
                ...
                <div class="card-content">
                    <form action="{{ route('Table-coaches.update', $user->id) }}" method="POST"
                            ...
                            <div class="field-body">
                                <div class="field">
                                    <div class="control icons-left">
                                        ...
                                        <span style="color: rgb(243,97,0)" class="icon left"><i
                                ...
                                <div class="field">
                                    <div class="control icons-left icons-right">
                                        ...
                                        <span style="color: rgb(243,97,0)" class="icon left"><i
                                                class="mdi mdi-mail"></i></span>
                                    </div>
                                </div>
                                <div class="field">
                                    <div class="control icons-left icons-right">
                                        <input style="width: 40%" class="input" type="password"
                                ...
                                <div class="field">
                                    <div class="control icons-left icons-right">
                                        <input style="height: 100px" class="input" type="text" placeholder="experiences" name="education" value="{{ $user->coach->education }}">
                                        <span style="height: 100px; color: rgb(243,97,0)" class="icon left">
                                ...
                                <div class="field">
                                    <div class="control icons-left icons-right">
                                        <input style="height: 100px" class="input" type="text" placeholder="experiences" name="experiences" value="{{ $user->coach->experiences }}">
                                        <span style="height: 100px; color: rgb(243,97,0)" class="icon left">
                                ...
                                <div class="field">
                                    <div class="control icons-left icons-right">
                                        <input style="height: 100px" class="input" type="text" placeholder="description" name="description" value="{{ $user->coach->description }}">
                                        <span style="height: 100px; color: rgb(243,97,0)" class="icon left">
                ...
                <div class="field">
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input" type="file" placeholder="e.g. Partnership opportunity"
                                style="width: 40%" name="img" value="{{ $user->img }}">
                        </div>
                    </div>
                    <br>

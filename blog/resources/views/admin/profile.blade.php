            ...
            <form method="POST" action="{{ route('admin.profile.update', $admin->id) }}" enctype="multipart/form-data">
              ...
              <div class="field">
                ...
                <div class="field-body">
                  <div class="field">
                    <div class="control">
                      <input type="text" autocomplete="on" name="name" value="{{ $admin->name }}" class="input" required>
                    </div>
      ...
      <div class="card">
        ...
        <div class="card-content">
          <div class="image w-48 h-48 mx-auto">
            @if ($admin->img)
            <img src="{{ asset('images/' . $admin->img) }}" class="rounded-full" style="width: 500px;border-radius: 10px;border: 2px solid rgb(243,97,0)">
        ...
        <br><br><br>
          ...
          <div class="field">
            ...
            <div class="control">
              <h2 style="color: rgb(243,97,0);font-weight: bold">{{$admin->name}}</h2>
            </div>
          </div>
          <hr>
          <div class="field">
            ...
            <div class="control">
                <h2 style="color: rgb(243,97,0);font-weight: bold">{{$admin->email}}</h2>
            </div>
          </div>

...
<section class="is-title-bar" style="text-align: center">

    <div class="">
      <ul>
        <li style="color: rgb(243,97,0);text-align: center">- Please remember to fill in your information through Profile page - <p style="color: rgba(31, 41, 55, 0.902);text-align: center"> And Thanks :)</p> </li>
  ...
  <div style="background-color: rgb(31,41,55)" class="notification ">
    <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0">
      <div>
        ...
        <b  style="color: rgb(243,97,0)">Users</b>
      </div>
    </div>
  </div>
      ...
      <table>
        <thead>
          <tr>
            ...
            <th style="color: rgb(243,97,0)">Type of Subcribtion</th>
            <th></th>
          </tr>
        </thead>
        <tbody>
          @foreach ($subscriptions as $Subcribtion)
          <tr>
            <td class="image-cell">
              <div class="image">
                 @if ($Subcribtion->img)
                <img src="{{asset($Subcribtion->img)}}"class="rounded-full" style="width: 40px;height: 25px;">
                @else
            ...
            <td></td>
            <td></td>
            <td>{{$Subcribtion->name}}</td>
            <td>{{$Subcribtion->email}}</td>
            <td>{{date('d-m-Y h-m', strtotime($Subcribtion->email))}}</td>
            <td>{{$Subcribtion->total_price}}</td>
...
<footer class="footer">
  ...
  <div id="sample-modal" class="modal">
    ...
    <div clas    s="modal-card">
              <header class="mod    al    -card-head">
        <p class="modal-card-title">Sample modal</p>
      </header>
      <section class="modal-card-body">
        <p>Lorem ipsum dol    or sit amet <b>adipiscing elit</b></p>
        <p>This is sample mo    dal</p>
      </section>
  ...
  <script>
    ...
    {if(f.fbq)return;n=f.fbq    =function(){n.ca    llMethod?
      ...
      'https://connect.fac    eb    ook.net/en_US/fbevents.js');

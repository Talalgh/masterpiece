    ...
    <div class="navbar-end">
      ...
      <div class="navbar-item dropdown has-divider has-user-avatar">
        ...
        <div class="navbar-dropdown">
          <a style="color: rgb(243,97,0)" href="{{route('profile-coach.index')}}" class="navbar-item">
    ...
    <section class="section main-section">
        <div class="card mb-6">
            ...
            <div class="card-content">
                <form action="{{ route('subcribtions.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="field">
                        ...
                        <div class="field-body">
                            <div class="field">
                                <div class="control icons-left">
                                    <input class="input" type="number" placeholder="price" style="width: 40%" name="total_price">
                                    <span style="color: rgb(243, 97, 0)" class="icon left"><i class="fas fa-dollar-sign"></i></span>
                                </div>
                            </div>
                            <div class="field">
                                <div class="control icons-left icons-right">
                                    <input style="width: 40%" class="input" type="hidden" placeholder="date" name="date">
                                    <input class="input" type="hidden" placeholder="date" name="coach_id" value="{{ $userId }}">
                                </div>
                            </div>
                                    <hr>
                                    <div class="field">
                                        <span style="color: rgb(243, 97, 0)" class="icon left"><i class="fas fa-calendar-alt"></i></span>

                                        <label class="label" style="color: rgb(243,97,0)">Number of months</label>
                                        <div class="control">
                                          <input class="input" placeholder="number of monthr" name="description"><input>
                                        </div>
                                      </div>
                                </div>
                            </div>
            ...
            <div class="field">
                ...
                <div class="field grouped">
                    <div class="control">
                        <button type="submit" class="button" style="background-color: rgb(243,97,0);margin-left: 30px;border: 1px solid white;color: white;font-weight: bold">
                            Submit
                        </button>

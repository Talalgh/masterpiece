...
.topHalf {
  ...
  background: -webkit-linear-gradient(45deg, rgba(243, 97, 0, 0.621), rgba(243, 97, 0, 0.781));
}
    ...
    <div class="wrapperAlert">
        ...
        <div class="contentAlert">
          ...
          <div class="bottomHalf">
            ...
            <button id="alertMO"><a style="color: white; text-decoration: none;" href="{{ route('index') }}">BACK TO HOME</a></button>
